...
def parse_arguments(argv):
    ...
    parser.add_argument('--mu0', type=float, help='mu0', default=1.0)
    parser.add_argument('--mu1', type=float, help='mu0', default=2.0)
    ...
    parser.add_argument('--mu_11', type=float, help='service rate in sub queue', default=1.0)
