...
def main(args):
    ...
    if sys.platform == 'linux':
        df = pd.read_excel('../files/accu_settings.xlsx', sheet_name='Sheet1')
    ...
    for ind in [3,4,6,7]:
        ...
        df_name_before = '../pkl/df_name_before.pkl' #os.path.join(pkl_path,df_name_before)
        ...
        if not os.path.exists(df_name_after) or True:
