...
def main(args):
    ...
    if sys.platform == 'linux':
        ...
        df = pd.read_excel(r'C:\Users\user\workspace\redirected_call\files\util0_res.xlsx', sheet_name='Sheet8')
        df = pkl.load(open('data_sim.pkl', 'rb'))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--end_time', type=float, help='The end of the simulation', default=40000)
