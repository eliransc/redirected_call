...
def main(args):
    ...
    for ind in tqdm(range(args.num_iterations)):
        ...
        print('The 90th precentile of wiating time in station 1 is: ', np.percentile(wait_arr, 90))
...
def parse_arguments(argv):
    ...
    parser.add_argument('--end_time', type=float, help='The end of the simulation', default=700000)
