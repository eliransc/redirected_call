...
def main(args):
    ...
    if sys.platform == 'linux':
        ...
        df = pd.read_excel(r'C:\Users\user\workspace\redirected_call\files\sum_results.xlsx', sheet_name='Sheet5')
...
def parse_arguments(argv):
    ...
    parser.add_argument('--end_time', type=float, help='The end of the simulation', default=10000)
    ...
    parser.add_argument('--df_summ', type=str, help='case number in my settings', default='../pkl/df_sum_res_sim_23.pkl')
