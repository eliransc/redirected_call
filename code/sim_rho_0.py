...
def parse_arguments(argv):
    ...
    parser.add_argument('--end_time', type=float, help='The end of the simulation', default=30000000)
    ...
    parser.add_argument('--df_summ', type=str, help='case number in my settings', default='../pkl/df_sum_res_sim_39.pkl')
